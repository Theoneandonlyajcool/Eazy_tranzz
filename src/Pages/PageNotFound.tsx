...
const PageNotFound = () => {
  ...
  return (
    <div className="bg-linear-to-bl from-[#b6057e] to-[#000000] diagonal-stripes min-h-screen flex flex-col items-center justify-center px-4 py-8">
      {/* 404 Numbers */}
      ...
      <button
        ...
        onClick={() => navigate("/")}
      >
        <div className="bg-linear-to-r from-[#9c056c] to-[#5f0242] rounded-xl h-12 w-1/4 flex items-center justify-center absolute left-1 top-1 group-hover:w-[97%] z-10 duration-500">
          <svg
