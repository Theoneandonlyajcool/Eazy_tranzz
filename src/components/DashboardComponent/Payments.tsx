  ...
  return (
    <div className="w-full rounded-2xl bg-white dark:bg-[linear-gradient(#1A1A2E,#0A0A0F)] p-6 shadow-lg border border-gray-200 dark:border-gray-800">
      <div className="mb-5 flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-[#222] dark:text-[#FFFFFF]">
            Payment Options & Rates
          </h2>
          <p className="text-sm text-gray-500 dark:text-[#99A1AF]">
            Live rates updated every 5 seconds
          </p>
        </div>
        <button className="rounded-full p-2 text-[#222] dark:text-white bg-gray-100 dark:bg-[rgba(173,70,255,0.20)] hover:bg-gray-200 dark:hover:bg-[rgba(173,70,255,0.30)] transition-colors cursor-pointer">
          <svg
            className="h-5 w-5"
            viewBox="0 0 24 24"
            fill="none"
        ...
        {payments.map((p) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div
                className={`flex h-10 w-10 items-center justify-center rounded-xl ${p.iconBg} text-sm font-bold text-white`}
              >
                <img
                  src={p.icon}
                  alt=""
